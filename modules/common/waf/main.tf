...
resource "oci_waas_waas_policy" "test_waas_policy" {
  ...
  # ?FIX THIS
  domain = "www.1de2.oci-caas.cloud"

  #Optional
  # additional_domains = ["www2.1de2.oci-caas.cloud"]
  ...
  policy_config {
    ...
    #   name                       = "name2"
    #   domain                     = "www2.1de2.oci-caas.cloud"
  ...
  waf_config {
    ...
    whitelists {
      ...
      #Optional
      addresses     = ["148.87.23.12", "148.87.23.10", "148.87.23.8"]
...
output "waf_cname" {
  value = oci_waas_waas_policy.test_waas_policy.cname
}